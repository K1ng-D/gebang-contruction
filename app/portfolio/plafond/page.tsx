...
// ===== Data (disesuaikan ke plafon) =====
const highlights = [
  {
    icon: FiShield,
    title: "Bergaransi",
    desc: "Garansi pemasangan & finishing sesuai perjanjian.",
  },
  {
    icon: FiClock,
    title: "Cepat & Rapi",
    desc: "Eksekusi terjadwal, area kerja bersih setiap hari.",
  },
  {
    icon: FiTool,
    title: "Material Standar",
    desc: "Rangka hollow/metal furring, papan berkualitas.",
  },
  {
    icon: FiMapPin,
    title: "Solo Raya",
    desc: "Layanan ke Solo, Sukoharjo, Karanganyar & sekitar.",
  },
];

const scopes = [
  "Plafon Gypsum (rangka hollow/metal furring)",
  "Plafon PVC anti lembab & mudah dibersihkan",
  "Plafon GRC/kalci untuk area lembab/outdoor terlindung",
  "Drop ceiling, up ceiling, layered ceiling",
  "Desain plafon minimalis, klasik, dan modern",
  "List/lis gypsum & profil dekoratif",
  "Hidden LED, cove lighting, spot downlight",
  "Peredam akustik (ruang meeting/studio) & insulasi panas",
  "Perapihan sambungan, dempul, dan pengecatan akhir",
  "Perbaikan kerusakan: retak, bocor, saging (melendut)",
];
...
const testimonials: Testi[] = [
  {
    name: "Bpk. Andi",
    role: "Pemilik Rumah – Colomadu",
    comment: "Plafon gypsum rapi, sambungan halus. Lighting jadi lebih elegan.",
    rating: 5,
  },
  {
    name: "Ibu Sari",
    role: "Pemilik Toko – Jl. Veteran",
    comment:
      "Pemasangan PVC cepat & bersih. Tahan lembab, cocok untuk area belakang.",
    rating: 5,
  },
  {
    name: "Bpk. Joko",
    role: "Manager – Kantor",
    comment:
      "Solusi akustiknya efektif. Ruang meeting jadi lebih nyaman & kedap.",
    rating: 5,
  },
];
...
const projectTeaser = [
  {
    id: "PL-001",
    title: "Plafon Gypsum + Cove Lighting",
    location: "Colomadu",
    year: 2025,
    cover: project1.src,
    tags: ["Gypsum", "LED"],
  ...
  {
    id: "PL-002",
    title: "Plafon PVC Anti Lembab – Dapur",
    location: "Solo",
    year: 2024,
    cover: project2.src,
    tags: ["PVC", "Kitchen"],
...
export default function PlafonLandingPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white text-slate-800">
      <Head>
        <title>Plafon | Gebang Construction</title>
        <meta
          name="description"
          content="Jasa plafon gypsum, PVC, GRC, dan akustik: desain drop/up ceiling, list gypsum, hidden LED, peredam suara, hingga pengecatan. Bergaransi & rapi."
        />
      </Head>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid lg:grid-cols-2 gap-10 py-16 lg:py-24 items-center">
            ...
            >
              <motion.h1
                variants={fadeUp()}
                className="text-4xl/tight md:text-5xl/tight font-bold tracking-tight"
              >
                Jasa{" "}
              ...
              >
                Desain elegan, sambungan halus, pencahayaan tersembunyi rapi.
                Pemasangan cepat & bersih—hasil akhir siap cat.
              </motion.p>
              <motion.div variants={fadeUp(0.2)} className="flex flex-wrap gap-3">
                <a
                  href="#keunggulan"
                  className="rounded-xl bg-amber-500 text-blue-900 px-5 py-3 text-sm shadow hover:shadow-md hover:bg-amber-400 transition-all"
                >
                  Lihat Keunggulan
                </a>
                <a
                  href="#proyek"
                  className="rounded-xl border border-blue-300 px-5 py-3 text-sm hover:border-blue-100 hover:bg-blue-800/30 transition-all"
                >
                  Lihat Proyek
                </a>
              </motion.div>
              <motion.ul
                variants={fadeUp(0.3)}
                className="flex items-center gap-4 text-blue-100 text-sm"
              >
                <li className="inline-flex items-center gap-2">
                  <FiCheckCircle className="text-amber-400" /> Bergaransi
                </li>
                <li className="inline-flex items-center gap-2">
                  <FiCheckCircle className="text-amber-400" /> Cepat & Rapi
                </li>
                <li className="inline-flex items-center gap-2">
                  <FiCheckCircle className="text-amber-400" /> Finishing Halus
                </li>
              </motion.ul>
            </motion.div>
            ...
            >
              <div className="aspect-[4/3] rounded-3xl bg-cover bg-center shadow-2xl relative overflow-hidden">
                ...
                <img
                  src={heroImage.src}
                  alt="Plafon – Gebang Construction"
      ...
      <section id="keunggulan" className="mx-auto max-w-7xl px-4 py-12 md:py-16">
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-slate-600 mt-2 max-w-2xl">
            Tim spesialis plafon: desain, struktur rangka, finishing, dan
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {highlights.map((h) => (
            ...
            >
              ...
              <h3 className="font-semibold tracking-tight text-blue-900">
                {h.title}
              </h3>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 md:py-16">
        <div className="mb-8 md:mb-12">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-blue-900">
            ...
            <p className="text-slate-600 mt-2 max-w-2xl">
              Ambil paket lengkap atau hanya bagian tertentu—fleksibel sesuai
              kebutuhan ruanganmu.
            </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
          {scopes.map((s) => (
            <div
              key={s}
              className="rounded-xl border border-blue-100 bg-white px-4 py-3 text-sm text-slate-700 flex items-start gap-2"
            >
              <FiCheckCircle className="mt-0.5 text-blue-600 shrink-0" />{" "}
              <span>{s}</span>
            </div>
          ))}
        </div>
      ...
      <section id="proyek" className="mx-auto max-w-7xl px-4 py-12 md:py-16">
        <div className="mb-8 md:mb-12 flex items-end justify-between gap-4">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-blue-900">
              Proyek Plafon Terbaru
            </h2>
            <p className="text-slate-600 mt-2 max-w-2xl">
              Cuplikan beberapa instalasi plafon terakhir kami: gypsum, PVC,
              hingga akustik.
            </p>
          </div>
          <Link
              ...
              <div className="p-4">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {p.tags.map((t) => (
                    <span
                      key={t}
                      className="inline-flex items-center gap-1 rounded-lg bg-blue-100 px-2.5 py-1 text-xs text-blue-800"
                    >
                      <FiAperture /> {t}
                    </span>
                  ))}
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 md:py-16">
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-slate-600 mt-2 max-w-2xl">
            Kerapian sambungan & hasil akhir halus adalah standar kami.
          </p>
        </div>
          ...
          {testimonials.map((t, i) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <figcaption className="font-semibold text-blue-900">
                    {t.name}
                  </figcaption>
              ...
              <div
                className="mt-3 flex gap-1 text-amber-400"
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 md:py-16">
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-slate-600 mt-2 max-w-2xl">
            Masih ada yang ingin ditanyakan? Hubungi kami—gratis konsultasi.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-6">
          {[
            {
              q: "Berapa lama pemasangan plafon rumah tipe 36–72?",
              a: "Umumnya 1–4 hari tergantung luas & kompleksitas (drop/cove). Timeline detail kami sertakan saat penawaran.",
            },
            {
              q: "Gypsum vs PVC, pilih mana?",
              a: "Gypsum: rapi, finishing cat bebas. PVC: tahan lembab & mudah dibersihkan. Kami bantu sesuaikan fungsi ruang.",
            },
            {
              q: "Apakah bisa custom desain lighting?",
              a: "Bisa. Hidden LED, cove, dan spot downlight kami rancang sesuai mood & kebutuhan pencahayaan.",
            },
            {
              q: "Bagaimana skema pembayaran?",
              a: "Termin sesuai progres (DP + pelunasan bertahap). Semua terdokumentasi & transparan.",
            },
          ].map((f, idx) => {
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <div
                      className={`text-sm text-slate-600 transition-all ${
                        open
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl md:text-3xl font-bold tracking-tight">
                Konsultasi Desain & Estimasi Plafon Gratis
              </h3>
              <p className="text-blue-100 mt-2 max-w-prose">
                Kirimkan ukuran ruangan & referensi desain—kami bantu RAB,
                pilihan material, dan opsi pencahayaan.
              </p>
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                <a
                  href="mailto:hello@gebangconstruction.id?subject=Konsultasi%20Plafon"
